...
public interface RoomReservationService {
    ...
    @POST("classroomManage/getBuildingSelector")
    Flowable<ResponseBean<List<Object>>> getBuildingSelector();
    @POST("classroomManage/getBuildingFloorSelector")
    Flowable<ResponseBean<List<Object>>> getBuildingFloor(String bname);
}
