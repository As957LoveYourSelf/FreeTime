...
public class PublicCourseFragment extends Fragment {
    ...
    public static PublicCourseFragment newInstance(List<Map<String, Object>> data) {
        PublicCourseFragment fragment = new PublicCourseFragment();
        if (data != null){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (view == null){
            view = inflater.inflate(R.layout.fragment_public_course, container, false);
        }
        return view;
    }
